...
public class App extends Application {
    ...
    private String SpotifyApiAccessToken;

    public String getSpotifyApiAccessToken() {
        return SpotifyApiAccessToken;
    }

    public void setSpotifyApiAccessToken(String spotifyApiAccessToken) {
        mSpotifyApi.setAccessToken(spotifyApiAccessToken);
